...
const FeatureCarousel = dynamic(() => import("../FeatureCarousel"), { ssr: false });
...
export default async function HardcodedPage({ params, searchParams }: Props) {
  ...
  const hardcodedPageSlug = params.hardcodedPageSlug;
  ...
  const featureImages = [
    ...
    { src: "/uploads/features/Layer-30-2.jpg", alt: "Layer 31" },
  ...
  return (
    <div className="container mx-auto px-4 py-8">
     ...
     <div className="mb-8">
        ...
        {/* Use FeatureCarousel for both desktop and mobile */}
        <div className="w-full relative">
          <FeatureCarousel images={featureImages} />
        </div>
